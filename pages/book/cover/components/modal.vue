<template>
	<cover-view>
		<u-popup :zoom="zoom" 
			...
			@close="popupClose"
		>
			<cover-view class="u-model">
				<cover-view v-if="showTitle" class="u-model-title u-line-1" :style="[titleStyle]">{{ title }}</cover-view>
				<cover-view class="u-model-content">
					<slot v-if="contentSlot">
					</slot>
					<cover-view v-else class="u-model-content-meeeage" :style="[contentStyle]">{{ content }}</cover-view>
				</cover-view>
				<cover-view class="u-model-footer u-border-top">
					<cover-view
